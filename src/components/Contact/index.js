                        ...
                        <tr>
                            <td className="left-side">
                                ...
                                <p>
                                    ...
                                    <br/>Please don't hesitate to get in touch with me by filling out the contact form.
                                    <br/>
                                    <a target = "_blank" rel = "noreferrer" href = "https://www.linkedin.com/in/hanbinbae/">
                                        <FontAwesomeIcon icon={faLinkedin}  class = "icon" color = "#4d4d4e" />
                                    </a>
                                    <a target = "_blank" rel = "noreferrer" href = "mailto:hn870092@dal.ca">
